...
def validate_config() -> None:
    ...
    required = {
        ...
        ("DOMAIN", "api-siri-prod.apple.com"): "PROXY",
        ("DOMAIN", "ropes.apple.com"): "PROXY",
        ("DOMAIN-SUFFIX", "apple-carry-relay.cloudflare.com"): "PROXY",
    ...
    ordered_markers = [
        ...
        "DOMAIN,api-siri-prod.apple.com,PROXY,force-remote-dns",
        "DOMAIN,ropes.apple.com,PROXY,force-remote-dns",
        "DOMAIN-SUFFIX,apple-carry-relay.cloudflare.com,PROXY,force-remote-dns",
